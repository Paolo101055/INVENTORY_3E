                                          ...
                                          $result =mysqli_query($conn, $sql);
                                              ...
                                              if (mysqli_num_rows($result)>0){
                                                while($row = mysqli_fetch_assoc($result)){
                                                  ...
                                                  echo "<td>".AccessName($row['accesstype'])."</td>";
                                                  echo "<td>".$row['dateCreated']."</td>";
                                                 
                                             

                                                  echo '<td>
                                                <a type="button" title="delete user" data-bs-toggle="modal"
                                                data-bs-target="#deleteUser'.$row['user_id'].'">
                                                <i class="icon-trash menu-icon"></i>
                                                </a>

                                                </td>';
                                                echo "</tr>";
                                                include "./modal/modalUserAuth.php";
                                                }
                                              }
